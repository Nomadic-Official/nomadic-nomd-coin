...
The build script we'll be using is contained in the NOMADIC github repository ([contrib/gitian-build.py](https://github.com/nomadic-project/nomadic/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the NOMADIC repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Nomadic-Official/nomadic-nomd-coin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, nomadic-detached-sigs, and nomadic GitHub repos.
