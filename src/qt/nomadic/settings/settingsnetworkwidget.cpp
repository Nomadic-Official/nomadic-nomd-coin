...
#include "qt/nomadic/settings/settingsnetworkwidget.h"
#include "qt/nomadic/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/nomadic/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(NOMADICGUI* _window, QWidget *parent) :
