...
#ifndef NOMADIC_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define NOMADIC_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //NOMADIC_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
