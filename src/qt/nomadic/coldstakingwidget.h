...
#include "qt/nomadic/furabstractlistitemdelegate.h"
#include "qt/nomadic/txviewholder.h"
#include "qt/nomadic/tooltipmenu.h"
#include "qt/nomadic/sendmultirow.h"
#include "qt/nomadic/coldstakingmodel.h"
#include "qt/nomadic/contactsdropdown.h"
#include "qt/nomadic/addressholder.h"
...
public:
    explicit ColdStakingWidget(NOMADICGUI* parent);
    ~ColdStakingWidget();
