...
RESOURCES += src/qt/nomadic.qrc src/qt/nomadic_locale.qrc

TRANSLATIONS += src/qt/locale/nomadic_bg.ts \
                src/qt/locale/nomadic_de.ts \
                src/qt/locale/nomadic_en.ts \
                src/qt/locale/nomadic_es.ts \
                src/qt/locale/nomadic_fi.ts \
                src/qt/locale/nomadic_fr.ts \
                src/qt/locale/nomadic_it.ts \
                src/qt/locale/nomadic_ja.ts \
                src/qt/locale/nomadic_pl.ts \
                src/qt/locale/nomadic_pt.ts \
                src/qt/locale/nomadic_ru.ts \
                src/qt/locale/nomadic_sk.ts \
                src/qt/locale/nomadic_sv.ts \
                src/qt/locale/nomadic_vi.ts \
                src/qt/locale/nomadic_zh_CN.ts \
                src/qt/locale/nomadic_zh_TW.ts
