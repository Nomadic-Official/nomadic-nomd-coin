...
#include "qt/nomadic/forms/ui_masternodewizarddialog.h"

#include "activemasternode.h"
#include "optionsmodel.h"
#include "pairresult.h"
#include "qt/nomadic/mnmodel.h"
    ...
    walletModel(model)
{
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("7020");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("3120");
    } else {
        ui->lineEditPort->setText("3020");
    }
