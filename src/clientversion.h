...
#error Client version information missing: version is not defined by nomadic-config.h or in any other way
#endif
...
/**
 * nomadicd-res.rc includes this file, but it cannot cope with real c++ code.
