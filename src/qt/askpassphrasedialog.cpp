...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            NOMADICGUI* window = static_cast<NOMADICGUI*>(parentWidget());
...
{
    NOMADICGUI* gui = static_cast<NOMADICGUI*>(parentWidget());
...
{
    hide();
    static_cast<NOMADICGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("NOMADIC will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your NOMDs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
