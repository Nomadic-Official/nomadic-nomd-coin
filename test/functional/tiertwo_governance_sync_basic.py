...
from test_framework.test_framework import NomadicTier2TestFramework
...
class MasternodeGovernanceBasicTest(NomadicTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.nomadic.org/t/test-proposal"
