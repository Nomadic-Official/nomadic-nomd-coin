...
class BudgetProposalTest(NomadicTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid NOMADIC address")
        assert_raises_rpc_error(-5, "Invalid NOMADIC address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of %.8f is less than minimum 10 NOMD allowed" % invalid_amt, self.nodes[0].preparebudget,
