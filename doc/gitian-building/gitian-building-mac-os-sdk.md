...
The script [extract-osx-sdk.sh](https://github.com/nomadic-project/nomadic/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
nomadic/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/nomadic-project/nomadic/blob/master/doc/README_osx.md) for troubleshooting tips.