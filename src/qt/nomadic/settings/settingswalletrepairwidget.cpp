...
#include "qt/nomadic/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/nomadic/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(NOMADICGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to NOMADICGUI::handleRestart()
