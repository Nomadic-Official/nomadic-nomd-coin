...
extern const char * const NOMADIC_CONF_FILENAME;
extern const char * const NOMADIC_PID_FILENAME;
extern const char * const NOMADIC_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("nomadic-%s", name);
