...
/** Utility functions used by the NOMADIC Qt UI.
 */
namespace GUIUtil
{
...
// Render NOMADIC addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZnomd = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZnomd = false);
...
// Parse "nomadic:" URI into recipient object, return true on successful parsing
