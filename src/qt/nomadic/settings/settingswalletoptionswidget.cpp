...
#include "qt/nomadic/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/nomadic/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(NOMADICGUI* _window, QWidget *parent) :
