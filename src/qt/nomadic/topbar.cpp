...
#include "qt/nomadic/topbar.h"
#include "qt/nomadic/forms/ui_topbar.h"
#include "qt/nomadic/lockunlock.h"
#include "qt/nomadic/qtutils.h"
#include "qt/nomadic/receivedialog.h"
#include "qt/nomadic/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/nomadic/balancebubble.h"
...
TopBar::TopBar(NOMADICGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopNomd, ui->labelAmountTopShieldedNomd}, "amount-small-topbar");
    setCssProperty({ui->labelAmountNomd}, "amount-topbar");
    setCssProperty({ui->labelPendingNomd, ui->labelImmatureNomd}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("NOMADIC")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // NOMD Total
    QString totalNomd = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // NOMD
    // Top
    ui->labelAmountTopNomd->setText(totalTransparent);
    ui->labelAmountTopShieldedNomd->setText(totalShielded);
    // Expanded
    ui->labelAmountNomd->setText(totalNomd);
    ui->labelPendingNomd->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureNomd->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
