...
"""Verify that starting nomadic with -h works as expected."""
import subprocess

from test_framework.test_framework import NomadicTestFramework
from test_framework.util import assert_equal

class HelpTest(NomadicTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nomadic with -? for help text")
        ...
        self.log.info("Start nomadic with -version for version information")
