...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(NOMD);
    unitlist.append(mNOMD);
    unitlist.append(uNOMD);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case NOMD:
        return QString("nomadic");
    case mNOMD:
        return QString("mnomadic");
    case uNOMD:
        return QString::fromUtf8("unomadic");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZnomd)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZNOMD)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZNOMD);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZNOMD)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZNOMD));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
