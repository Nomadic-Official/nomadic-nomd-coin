#!/usr/bin/env python3
# Copyright (c) 2020 The NOMADIC Core developers
...
class SaplingMempoolTest(NomadicTestFramework):
    ...
    def run_test(self):
        ...
        # miner sends a 10 NOMD note to Alice
        ...
        # miner sends another 10 NOMD note to Alice
