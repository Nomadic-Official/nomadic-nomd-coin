...
class ListReceivedTest (NomadicTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 NOMD.
        ...
        # Send 1 NOMD to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 NOMD sending them all (fee is 0.1 NOMD)
        ...
        # Confirm transaction (2 NOMD from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 NOMD, send 0.6 NOMD + 0.05 NOMD fee
