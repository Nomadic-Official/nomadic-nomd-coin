...
#include "config/nomadic-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalNomd = 0;
    qint64 totalZnomd = 0;
    QList<qreal> valuesNomd;
    QList<qreal> valueszNomd;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(NOMADICGUI* _window);
    ~DashboardWidget();
