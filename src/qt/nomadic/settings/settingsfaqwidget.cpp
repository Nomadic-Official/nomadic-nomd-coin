...
#include "qt/nomadic/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/nomadic/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(NOMADICGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableNOMD,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableNOMD,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableNOMD,
    ...
    connect(ui->pushButton_UnspendableNOMD, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableNOMD);});
    ...
    if (parent)
        connect(parent, &NOMADICGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
