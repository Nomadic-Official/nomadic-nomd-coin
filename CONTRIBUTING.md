Contributing to NOMADIC Core
============================

The NOMADIC Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nomadic-project/nomadic/blob/master/doc/translation_process.md)
...
The following applies to code changes to the NOMADIC Core project, and is not to be
confused with overall NOMADIC Network Protocol consensus changes.

Whether a pull request is merged into NOMADIC Core rests with the project merge
...
Patches that change NOMADIC consensus rules are considerably more involved than
...
Where a patchset proposes to change the NOMADIC consensus, it must have been
...
The project leader is the release manager for each NOMADIC Core release.
