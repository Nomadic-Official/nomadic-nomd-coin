...
#include "qt/nomadic/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(NOMADICGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("NOMADIC_tx_csv_export(*.csv)") : tr("NOMADIC_addresses_csv_export(*.csv)"),
                                        nullptr);
