...
/* Nomadic GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "NOMADIC"
#define QAPP_ORG_DOMAIN "nomadic.org"
#define QAPP_APP_NAME_DEFAULT "NOMADIC-Qt"
#define QAPP_APP_NAME_TESTNET "NOMADIC-Qt-testnet"
